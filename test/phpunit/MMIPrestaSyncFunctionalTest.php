...
/**
 * \file    test/phpunit/MMIPrestaSyncFunctionalTest.php
...
/**
 * Class MMIPrestaSyncFunctionalTest
 *
 ...
 *
 * @package Testmmiprestasync
 */
class MMIPrestaSyncFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIPrestaSync')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIPrestaSync')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmiprestasync/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmiprestasync/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmiprestasync/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmiprestasync/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmiprestasyncwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIPrestaSync_MMIPrestaSyncTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIPrestaSync_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
