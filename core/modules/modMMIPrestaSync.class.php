...
class modMMIPrestaSync extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		// Societe
        $extrafields->addExtraField('p_group', $langs->trans('Extrafield_p_group'), 'sellist', 100, '', 'societe', 0, 0, '', "a:1:{s:7:\"options\";a:1:{s:31:\"c_societe_p_group:label:rowid::\";N;}}", 1, '', 5, $langs->trans('ExtrafieldToolTip_p_group'), '', $conf->entity, 'mmiprestasync@mmiprestasync', '$conf->mmiprestasync->enabled');
